...
#ifndef BPP_PHYL_MODEL_CHROMOSOMESUBSTITUTIONMODEL_H
#define BPP_PHYL_MODEL_CHROMOSOMESUBSTITUTIONMODEL_H
...
#endif  // BPP_PHYL_MODEL_CHROMOSOMESUBSTITUTIONMODEL_H