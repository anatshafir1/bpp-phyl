...
#ifndef BPP_PHYL_LIKELIHOOD_DATAFLOW_FWLIKMLANCESTRALRECONSTRUCTION_H
#define BPP_PHYL_LIKELIHOOD_DATAFLOW_FWLIKMLANCESTRALRECONSTRUCTION_H
    ...
    class FwLikMLAncestralReconstruction: public AssociationDAGlobalGraphObserver<ConditionalLikelihoodForward,ForwardLikelihoodBelow>{
        ...
        public:
            FwLikMLAncestralReconstruction(Context& c, 
                          ...
                          const StateMap& statemap, ValueRef<Eigen::RowVectorXd> rootFreqs) : DAClass(), context_(c), processTree_(tree), likelihoodMatrixDim_(),
...
#endif // BPP_PHYL_LIKELIHOOD_DATAFLOW_FWLIKMLANCESTRALRECONSTRUCTION_H