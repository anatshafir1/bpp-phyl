...
int main(){
    ...
    ChromosomeSubstitutionModel* chr_model = new ChromosomeSubstitutionModel(chr_alpha, 2, 1, 3, 1.3, IgnoreParam, IgnoreParam, IgnoreParam, IgnoreParam, IgnoreParam, maxObservedChrNum-minObservedChrNum, ChromosomeSubstitutionModel::rootFreqType::ROOT_LL, ChromosomeSubstitutionModel::LINEAR, false);
